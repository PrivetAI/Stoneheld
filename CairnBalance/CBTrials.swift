...
enum CBTrialData {
    ...
    static let all: [CBTrial] = [
        ...
        CBTrial(id: 9, band: 0, name: "Small Weather",
        ...
        CBTrial(id: 13, band: 1, name: "Split Foot",
        ...
        CBTrial(id: 19, band: 1, name: "Quarry Wind",
        ...
        CBTrial(id: 20, band: 1, name: "Broadfoot",
        ...
        // ------------------------------------------------ Band 2 — River Bend
        CBTrial(id: 21, band: 2, name: "Slack Water",
        ...
        CBTrial(id: 24, band: 2, name: "Riffle",
        ...
        CBTrial(id: 25, band: 2, name: "Otter Line",
        ...
        CBTrial(id: 28, band: 2, name: "Willow Bar",
        ...
        CBTrial(id: 29, band: 2, name: "River Wind",
        ...
        CBTrial(id: 30, band: 2, name: "Long Bend",
        ...
        CBTrial(id: 33, band: 3, name: "Nine Columns",
        ...
        CBTrial(id: 34, band: 3, name: "Cinder",
        ...
        CBTrial(id: 35, band: 3, name: "Anvil",
        ...
        CBTrial(id: 38, band: 3, name: "Dyke",
        ...
        CBTrial(id: 39, band: 3, name: "Windward Point",
        ...
        CBTrial(id: 40, band: 3, name: "The Cairn",
    ...
    static func trial(_ id: Int) -> CBTrial? {
        all.first(where: { $0.id == id })
    }

    static func band(_ b: Int) -> [CBTrial] {
        all.filter { $0.band == b }
    }
